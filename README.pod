...
=head1 The App::irr_rpsl_submit module

This is the I<README> for the L<App::irr_rpsl_submit> Perl module.
...
and install the dependencies:
	...
	% cpan App::irr_rpsl_submit
	% cpanm App::irr_rpsl_submit
...
the source repository: L<https://github.com/briandfoy/app-irr_rpsl_submit>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/app-irr_rpsl_submit/issues>.
...
=item * L<https://bitbucket.com/briandfoy/app-irr_rpsl_submit>

=item * L<https://codeberg.org/briandfoy/app-irr_rpsl_submit>

=item * L<https://gitlab.com/briandfoy/app-irr_rpsl_submit>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify App::irr_rpsl_submit-1.23.tar.gz --owner briandfoy
